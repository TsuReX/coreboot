  ...
  )
{
  //CHAR16                   *NewString;
  /*
  NewString = HiiGetString(gFrontPagePrivate.HiiHandle, STRING_TOKEN(STR_FRONT_PAGE_TITLE_LEFT), NULL);
  UiCustomizeFrontPageBanner(1, TRUE, &NewString);
  HiiSetString(gFrontPagePrivate.HiiHandle, STRING_TOKEN(STR_FRONT_PAGE_TITLE_LEFT), NewString, NULL);
  FreePool(NewString);

  NewString = HiiGetString(gFrontPagePrivate.HiiHandle, STRING_TOKEN(STR_FRONT_PAGE_TITLE_RIGHT), NULL);
  UiCustomizeFrontPageBanner(1, FALSE, &NewString);
  HiiSetString(gFrontPagePrivate.HiiHandle, STRING_TOKEN(STR_FRONT_PAGE_TITLE_RIGHT), NewString, NULL);
  FreePool (NewString);
  */
}
