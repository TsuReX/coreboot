  ...
  )
{
  ...
  if (PostCodeValue != 0) {
	...
	AsciiSPrint (PostCodeBuffer,
               sizeof (PostCodeBuffer),
               "%02X\0",
               PostCodeValue);
    TextOutPpi->SetCursorPosition(TextOutPpi, 77, 24);
    TextOutPpi->WriteString (TextOutPpi, 2, (UINT8 *)PostCodeBuffer);
