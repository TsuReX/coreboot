  ...
  )
{
  ...
  //
  // Create "Enable Shell Boot" line.
  //
  BmmCreateShellBootMenu (HiiHandle, StartOpCodeHandle);
  
  //
  // Create Enable Network Boot line.
  //
  BmmCreateNetworkBootMenu (HiiHandle, StartOpCodeHandle);
