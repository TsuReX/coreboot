...
/**
  Create Shell Boot Menu in the page.
  ...
  )
{
    HiiCreateCheckBoxOpCode (
      StartOpCodeHandle,
      (EFI_QUESTION_ID)SHELL_BOOT_QUESTION_ID,
      VARSTORE_ID_BOOT_MAINT,
      BOOT_SHELL_VAR_OFFSET,
      STRING_TOKEN (STR_SHELL_BOOT),
      STRING_TOKEN (STR_SHELL_BOOT_HELP),
      0,
      0,
      NULL
      );
...
/**
  Create Network Boot Menu in the page.
  ...
  )
{
    HiiCreateCheckBoxOpCode (
      StartOpCodeHandle,
      (EFI_QUESTION_ID)NETWORK_BOOT_QUESTION_ID,
      VARSTORE_ID_BOOT_MAINT,
      BOOT_NETWORK_VAR_OFFSET,
      STRING_TOKEN (STR_NETWORK_BOOT),
      STRING_TOKEN (STR_NETWORK_BOOT_HELP),
      0,
      0,
      NULL
      );
