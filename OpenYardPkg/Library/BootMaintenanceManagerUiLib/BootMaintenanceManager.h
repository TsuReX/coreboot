...
#define BOOT_SHELL_VAR_OFFSET           VAR_OFFSET (EnableShellBoot)
#define BOOT_NETWORK_VAR_OFFSET         VAR_OFFSET (EnableNetworkBoot)
...
#define SHELL_BOOT_QUESTION_ID           QUESTION_ID (EnableShellBoot)
#define NETWORK_BOOT_QUESTION_ID         QUESTION_ID (EnableNetworkBoot)
