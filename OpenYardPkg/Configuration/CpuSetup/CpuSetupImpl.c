/** @file
  HII Config Access protocol implementation of CpuSetupDxe driver.
...
CPU_SETUP_CONFIG_PRIVATE_DATA mCpuSetupConfigPrivateDataTemplate = {
  CPU_SETUP_CONFIG_PRIVATE_DATA_SIGNATURE,
  {
...
HII_VENDOR_DEVICE_PATH       mCpuSetupHiiVendorDevicePath = {
  {
    {
  ...
  )
{
  ...
  EFI_GUID gCpuSetupFormSetGuid = CPU_SETUP_FORM_SET_GUID;

  //
  // Publish the HII package list
  //
  HiiHandle = HiiAddPackages (
                &gCpuSetupFormSetGuid,
                DriverHandle,
                CpuSetupDxeStrings,
                CpuSetupHiiBin,
                NULL
