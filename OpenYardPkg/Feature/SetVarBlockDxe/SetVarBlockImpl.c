/** @file
  HII Config Access protocol implementation of SetVarBlockDxe driver.
...
EFI_GUID   mSetVarBlockVarGuid = SET_VAR_BLOCK_VAR_GUID;
CHAR16     mSetVarBlockVarName[] = SET_VAR_BLOCK_VAR_NAME;

SET_VAR_BLOCK_CONFIG_PRIVATE_DATA mSetVarBlockConfigPrivateDataTemplate = {
  SET_VAR_BLOCK_CONFIG_PRIVATE_DATA_SIGNATURE,
  {
    0
  },
  {
...
HII_VENDOR_DEVICE_PATH       mSetVarBlockHiiVendorDevicePath = {
  {
    {
  ...
  )
{
  ...
  Status = gBS->InstallMultipleProtocolInterfaces (
                  ...
                  &mSetVarBlockHiiVendorDevicePath,
  ...
  EFI_GUID gSetVarBlockFormSetGuid = SET_VAR_BLOCK_FORM_SET_GUID;

  //
  // Publish the HII package list
  //
  HiiHandle = HiiAddPackages (
                &gSetVarBlockFormSetGuid,
                DriverHandle,
                SetVarBlockDxeStrings,
                SetVarBlockHiiBin,
                NULL
                );
  if (HiiHandle == NULL) {
  ...
  BufferSize = sizeof(SET_VAR_BLOCK_CONFIGURATION);
  ...
  if (EFI_ERROR(Status)) {  // Not definded yet so add it to the NV Variables.
    Status = gRT->SetVariable(
      ...
      sizeof(SET_VAR_BLOCK_CONFIGURATION),
...
**/
VOID
UninstallSetVarBlockConfigForm (
  IN OUT SET_VAR_BLOCK_CONFIG_PRIVATE_DATA       *ConfigPrivateData
  )
{
  //
